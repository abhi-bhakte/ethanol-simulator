% Entry point for the Ethanol Distillation Simulator
% function start_experiment

% This file calls the main start_experiment function from the main directory
clc;
clear;
% close all;
...
global no_of_tasks tasks id_num sequence_task task fid_alarm_timing calibration_completed calibration_step
...
% pause  % Commented out to eliminate second Enter press requirement
clc
...
% % pause();
% setDesktopVisibility('off')
% making_ready_for(task_no,fault_no_list,fault_no); % Removed duplicate call
