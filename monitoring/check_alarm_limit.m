...
for i = 1: number_var_alarms
 ...
 for p = 1 : number_var_alarms
    ...
    for u = 1:length(acend_index)
       ...
       % set(alarm_text{u,2},'String',get_text,'foregroundcolor',[0 0 0],'fontangle','normal','fontweight','bold');
    ...
    for  u =length(acend_index)+1 : 10
        ...
        set(alarm_text{u,1},'String','ABCDEFGHIH','foregroundcolor',cvv,'fontangle','normal','fontweight','bold');
%         set(alarm_text{u,2},'String','ABCDEFGHIG','foregroundcolor',cvv,'fontangle','normal','fontweight','bold');
       set(alarm_text{u,2},'String','AABCDEFGHIJH','foregroundcolor',cvv,'fontangle','normal','fontweight','bold');
        set(alarm_text{u,3},'String','ABCDEFGHIHJ','foregroundcolor',cvv,'fontangle','normal','fontweight','bold');
        set(alarm_text{u,4},'String','ABCDEFGHIJK','foregroundcolor',cvv,'fontangle','normal','fontweight','bold');
